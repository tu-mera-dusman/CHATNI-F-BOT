                ...
                button = [
                    [
                        InlineKeyboardButton(
                            ...
                            url=f"https://github.com/Shivmis/1"
                        )
                    ]
                ]
                    ...
                    results=[
                        (
                            InlineQueryResultPhoto(
                                photo_url=f"https://graph.org/file/ec2a2cf3146c1bdfdb1a5-afe5a1efe40c20b6d0.jpg",
                                title="🥀 Branded Userbot ✨",
                                thumb_url=f"https://graph.org/file/ec2a2cf3146c1bdfdb1a5-afe5a1efe40c20b6d0.jpg",
